...
ALTER TABLE "users_table" RENAME COLUMN "emails" TO "email";--> statement-breakpoint
ALTER TABLE "users_table" DROP CONSTRAINT "users_table_emails_unique";--> statement-breakpoint
ALTER TABLE "posts_table" ALTER COLUMN "user_id" SET DATA TYPE uuid;--> statement-breakpoint
...
ALTER TABLE "users_table" ADD COLUMN "role" "user_roles" DEFAULT 'user' NOT NULL;--> statement-breakpoint
ALTER TABLE "users_table" ADD COLUMN "createdAt" timestamp with time zone DEFAULT now() NOT NULL;--> statement-breakpoint
ALTER TABLE "user_oauth_accounts" ADD CONSTRAINT "user_oauth_accounts_userId_users_table_id_fk" FOREIGN KEY ("userId") REFERENCES "public"."users_table"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
